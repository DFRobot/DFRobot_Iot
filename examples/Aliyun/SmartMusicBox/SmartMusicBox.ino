 ...
 *
 * @brief Connect the speakers. 
 * @brief You can choose to play music according to the instructions sent by the cloud platform.
 *
...
void callback(char *topic, byte *payload, unsigned int len)
{
  ...
  const uint16_t playWitchOne = jsonBuffer["params"][Identifier];
