 ...
 *
 * @brief Connect the relay. 
 * @brief It can be selected to be turned on or off according to the instructions sent by the cloud platform. 
 * @brief Implemented a remote control socket or switch
 *
 *
...
void callback(char *topic, byte *payload, unsigned int len)
{
  ...
  const uint8_t SocketStatus = jsonBuffer["params"][Identifier];
